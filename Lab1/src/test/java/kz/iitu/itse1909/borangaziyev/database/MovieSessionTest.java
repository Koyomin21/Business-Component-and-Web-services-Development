...
class MovieSessionTest {
    ...
    void testToString() {
        ...
        Assertions.assertEquals("Session: Movie: getTitleResponseSession date: nullTime: null - null", result);
    }
    ...
    void testSetSessionDate() {
        movieSession.setSessionDate(LocalDate.of(2022, Month.FEBRUARY, 1));
    }

    @Test
    void testSetStartTime() {
        movieSession.setStartTime(LocalTime.of(23, 3, 52));
    }

    @Test
    void testSetEndTime() {
        movieSession.setEndTime(LocalTime.of(23, 3, 52));
    }
